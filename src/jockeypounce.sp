...
public OnPluginStart()
{
	...
	g_hPounceScale = CreateConVar( "l4d2_JockeyPounce_scale", "0.6", "Scale how much damage the pounce does (e.g. 0.5 will half the default damage, 5 will make it 5 times more powerfull)", FCVAR_PLUGIN );
	g_hPounceCap = CreateConVar( "l4d2_JockeyPounce_cap", "20", "Cap of the maximum damage a pounce can do", FCVAR_PLUGIN );
	g_hPounceMinShow = CreateConVar( "l4d2_JockeyPounce_minshow", "5", "Minimum damage a pounce should do to show the pounce message", FCVAR_PLUGIN );
	g_hPounceDisplay = CreateConVar( "l4d2_JockeyPounce_display", "1", "How message should be shown, 0 - Disabled, 1 - Chat message, 2 - Hint Message", FCVAR_PLUGIN );
	g_hPounceDisplayMax = CreateConVar( "l4d2_JockeyPounce_display_max", "0", "Show the damagecap in the display message", FCVAR_PLUGIN );
	g_hPounceStoreStats = CreateConVar( "l4d2_JockeyPounce_store_stats", "0", "Save the pounces in a database", FCVAR_PLUGIN );
